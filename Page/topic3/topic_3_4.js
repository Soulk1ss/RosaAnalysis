...
export default function topic_3_4({ navigation }) {
        ...
        <View style={styles.container}>
            <Card containerStyle={styles.card}>
                <View style={styles.title}>
                    ...
                    <Text style={styles.font}>เลือกตามลักษณะการใช้แป้นพิมพ์</Text>
                </View>
                <View style={styles.body}>
                    <View style={styles.cardBody}>
                        <LinearGradient colors={['#FFFFFF', '#DDDDDD']} style={[styles.linearGradient, styles.shadows]}>
                            <Image source={require('../../assets/stance/IMG_3155.png')} style={[styles.image, { width: '50%', height: '50%' }]} resizeMode="center" />
                            <Text style={styles.text}>ข้อมือตรงหัวไหล</Text>
                    ...
                    <View style={styles.cardBody}>
                        <LinearGradient colors={['#FFFFFF', '#DDDDDD']} style={[styles.linearGradient, styles.shadows]}>
                            <Image source={require('../../assets/stance/IMG_3156.png')} style={styles.image} resizeMode="center" />
                            <Text style={[styles.text, { paddingTop: '2%' }]}>ข้อมือกระตก</Text>
                            <CheckBox
                                checkedIcon='dot-circle-o'
                                uncheckedIcon='circle-o'
                                checked={choice2}
