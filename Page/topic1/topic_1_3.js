                ...
                (data) => <View style={styles.container}>
                    ...
                    <View style={styles.body}>
                        <Card containerStyle={styles.card}>
                            <Text style={styles.text}>แคบเกินโดยนั่งแล้วโต๊ะติดกับขา</Text>
                            <View style={styles.bodyCard}>
                                <View style={styles.bodyImage}>
                                    <Image source={require('../../assets/stance/IMG_3032.png')} style={styles.image} resizeMode="center" />
                                </View>
                        ...
                        <Card containerStyle={[styles.card, { height: '40%' }]}>
                            <Text style={styles.text}>เก้าอี้ไม่สามารถปรับความสูงขึ้น-ลงได้</Text>
                            <View style={styles.bodyCard}>
                    ...
                    <TouchableOpacity style={styles.btnNext} onPress={() => data.setScore_a1(score, point_1, point_2) ? navigation.navigate('Topic_1') : Alert.alert('กรุณาเลือกคำตอบ')}>
