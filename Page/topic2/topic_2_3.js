...
export default function topic_2_3({ route, navigation }) {
                        ...
                        <View style={styles.body}>
                            <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                                ...
                                <Card containerStyle={styles.card}>
                                    <Text style={styles.text}>หันคอเข้าหาจอมากกว่า 30 องศา</Text>
                                    <View style={styles.bodyCard}>
                                        <View style={styles.bodyImage}>
                                            <Image source={require('../../assets/stance/IMG_3106_2.png')} style={styles.image} resizeMode="center" />
                                        </View>
                                ...
                                <Card containerStyle={styles.card}>
                                    <Text style={styles.text}>มีแสงจ้าที่หน้าจอ</Text>
                                    <View style={styles.bodyCard}>
                                        <View style={styles.bodyImage}>
                                            <Image source={require('../../assets/stance/IMG_3105.png')} style={styles.image} resizeMode="center" />
                                        </View>
                                        <View style={styles.bodyCheckbox}>
                                            <View style={styles.groupCheckbox}>
                                                <CheckBox
                                ...
                                <Card containerStyle={styles.card}>
                                    <Text style={styles.text}>ไม่มีแท่นวางเอกสาร</Text>
                                    <View style={styles.bodyCard}>
                                        <View style={styles.bodyImage}>
                                            <Image source={require('../../assets/stance/IMG_3105_2.png')} style={styles.image} resizeMode="center" />
                                        </View>
                                        <View style={styles.bodyCheckbox}>
                                            <View style={styles.groupCheckbox}>
                                                <CheckBox
                                ...
                                <Card containerStyle={styles.card}>
                                    <Text style={styles.text}>จอวางอยู่ไกล</Text>
                                    <View style={styles.bodyCard}>
                                ...
                                <View style={{ height: '6%', width: '100%', alignItems: 'center', justifyContent: 'flex-end' }}>
                                    <TouchableOpacity style={styles.btnNext} onPress={() => data.setScore_b1(score, point_1, point_2, point_3, point_4, point_5) ? navigation.navigate('Topic_2') : Alert.alert('กรุณาเลือกคำตอบ')}>
